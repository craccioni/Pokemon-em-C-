   	...
   	while (opcao != '4') { //LAÇO PA PODER RETORNAR PRAS TELAS
		...
		if (opcao == '1') { 
			...
			while ((pokemon[0].hp > 0) || (pokemon[1].hp > 0)) {
				...
				if (armor1 < 1) {
					//atacar(1, pokemon, pokemon+1);  ///FUNCAO ATACAR
					armor1 = 100000;
				}
				if ((pokemon[1].hp) < 1){
					break;
				...
				if (armor2 < 1) {
					//atacar(2, pokemon, pokemon+1); /// FUNCAO ATACAR
					armor2 = 100000;
				}
				if ((pokemon[0].hp) < 1){
					break;
...
void preenche(POKEBOLA *pokemon, JOGADOR *treinador){
	int i;
		for (i=0; i<2; i++){	
			...
			printf ("\n\t\t\tQuais são os nomes de seus Pokemóns? ");
			scanf (" %s",&treinador[i].pokemons);						
			printf ("\n\t\t\tJogador %d, \n\t\t\tQual Pokémon você escolherá para a batalha? ",i+1);
			scanf (" %s",&pokemon[i].nome);
			printf ("\n\t\t\tQual é o tipo do seu Pokémon? ");
			scanf (" %s",&pokemon[i].tipo);	
			printf ("\n\t\t\tQual é o peso do seu Pokémon? ");
			scanf ("%f",&pokemon[i].peso);
			printf ("\n\t\t\tQual é a altura do seu Pokémon? ");
			scanf ("%f",&pokemon[i].altura);
			printf ("\n\t\t\tQual é o valor de vida total do seu Pokémon? ");
			scanf ("%d",&pokemon[i].hp);			
			printf ("\n\t\t\tQual é o dano máximo do seu Pokémon? ");
			scanf ("%d",&pokemon[i].dano);
			printf ("\n\t\t\tQual é o valor de defesa do seu Pokémon? ");
			scanf ("%d",&pokemon[i].defesa);
			printf ("\n\t\t\tQual é a probailidade de defesa do seu Pokémon? ");
			scanf ("%d",&pokemon[i].prob_defesa);
			printf ("\n\t\t\tQual é a destreza do seu Pokémon? ");
			scanf ("%d",&pokemon[i].destreza);
			printf ("\n\t\t\tQual é a probabiliadade de esquiva do seu Pokémon? ");
			scanf ("%d",&pokemon[i].prob_esquiva);
			printf ("\n\t\t\tQual é a velocidade de ataque do seu Pokémon? ");
			scanf ("%d",&pokemon[i].atcksp);
			printf ("\n\t\t\tQual é o valor de penetração mágica do seu Pokémon? ");
